...
export default function About() {
  ...
  return (
    <section id="about" className="py-16 sm:py-24 border-t border-slate-200 dark:border-[#252925]">
      <div className="wrap max-w-4xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-slate-900 dark:text-[#f4f5f2] uppercase tracking-tight mb-6">
            ABOUT ARAVIND
          </h2>

          <p className="text-slate-600 dark:text-[#9da39d] text-lg sm:text-xl leading-relaxed mb-8 font-medium">
          ...
          <div className="border-t border-slate-200 dark:border-[#252925] pt-6">
            <h3 className="text-xs font-mono font-bold text-emerald-600 dark:text-[#c7ff4a] uppercase tracking-wider mb-4">
              Core Technical Capabilities
            </h3>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {capabilities.map((cap) => (
                <div key={cap} className="flex items-center gap-2.5 text-sm font-semibold text-slate-800 dark:text-[#f4f5f2]">
